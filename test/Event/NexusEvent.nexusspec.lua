...
Unit tests for the NexusEvent class.
--]]
...
local NexusEventModule = EventFolder:WaitForChild("NexusEvent")

local NexusEvent = require(NexusEventModule)
local NexusEventTest = NexusUnitTesting.UnitTest:Extend()
...
Sets up the test.
--]]
function NexusEventTest:Setup()
    self.CuT = NexusEvent.new()
end

--[[
Cleans up the test.
--]]
function NexusEventTest:Teardown()
    self.CuT:Disconnect()
end
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("Constructor"):SetRun(function(self)
    --Run the assertions.
    self:AssertEquals(self.CuT.ClassName,"NexusEvent","ClassName isn't properly set.")
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("Connect"):SetRun(function(self)
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("Disconnected"):SetRun(function(self)
    --Create the incrementer function.
    local TimesInvoked = 0
    local function Invoked()
        TimesInvoked = TimesInvoked + 1
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("Fire"):SetRun(function(self)
    --Create the incrementer function.
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("FireLoop"):SetRun(function(self)
    --Create the incrementer function.
    local Sum = 0
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("FireTable"):SetRun(function(self)
    --Create the incrementer function.
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("Disconnect"):SetRun(function(self)
    --Create the incrementer function.
    local TimesInvoked = 0
    local function Invoked()
        TimesInvoked = TimesInvoked + 1
...
--]]
NexusUnitTesting:RegisterUnitTest(NexusEventTest.new("Wait"):SetRun(function(self)
    --Create the object.
    local CuT = NexusEvent.new()
